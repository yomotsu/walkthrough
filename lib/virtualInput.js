...
( function ( ns ) {
  ...
  ssss = 'pointerdown MSPointerDown touchstart mousedown';
  ...
  ns.Joystick = function ( $container, size, params ) {
    ...
    var onbuttonmove = function ( event ) {
      ...
      x = (   ( _event.clientX - that.offset.left ) - that.halfWidth ) / that.halfWidth * 2;
      y = ( - ( _event.clientY - that.offset.top  ) + that.halfWidth ) / that.halfWidth * 2;
